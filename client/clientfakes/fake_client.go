...
type FakeClient struct {
	...
	GetIssuesStub        func(context.Context, string, []string, time.Time, time.Time) models.Issues
...
func (fake *FakeClient) GetIssues(arg1 context.Context, arg2 string, arg3 []string, arg4 time.Time, arg5 time.Time) models.Issues {
	var arg3Copy []string
	if arg3 != nil {
...
func (fake *FakeClient) GetIssuesCalls(stub func(context.Context, string, []string, time.Time, time.Time) models.Issues) {
	fake.getIssuesMutex.Lock()
...
func (fake *FakeClient) GetIssuesReturns(result1 models.Issues) {
	fake.getIssuesMutex.Lock()
	defer fake.getIssuesMutex.Unlock()
...
func (fake *FakeClient) GetIssuesReturnsOnCall(i int, result1 models.Issues) {
	fake.getIssuesMutex.Lock()
	defer fake.getIssuesMutex.Unlock()
	fake.GetIssuesStub = nil
